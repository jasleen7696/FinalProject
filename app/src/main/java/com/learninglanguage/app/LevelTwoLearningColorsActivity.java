...
import com.learninglanguage.app.Adapters.LevelTwoColorsCardAdapter;

public class LevelTwoLearningColorsActivity extends AppCompatActivity {

    private ViewPager slideview;
    private LinearLayout slideNav;
    private LevelTwoColorsCardAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_two_learning_colors);
        initComponents();

        adapter = new LevelTwoColorsCardAdapter(this);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (next.getText().toString().equals("Next Lesson")){
                    startActivity(new Intent(LevelTwoLearningColorsActivity.this,LevelTwoLearningShapesActivity.class));
                }else{
                    slideview.setCurrentItem(currentPage + 1);
                }
            }
    ...
    private void dotsViewIndicator(int position) {
        ...
        if (mDots.length > 0) {
            MediaPlayer.create(LevelTwoLearningColorsActivity.this,voice_clips[position]).start();
