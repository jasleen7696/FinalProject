...
public class LevelTwoShapesCardAdapter extends PagerAdapter {

    Context context;
    LayoutInflater inflater;

    public LevelTwoShapesCardAdapter(Context context) {
        this.context = context;
    }

    public int[] slide_shapes = {
            R.drawable.l2_circle,
            R.drawable.l2_sqaure,
            R.drawable.l2_star,
            R.drawable.l2_triangle,
            R.drawable.l2_hexagon,
            R.drawable.l2_oval,
            R.drawable.l2_pentagon,
            R.drawable.l2_rhombus,
            R.drawable.l2_octagon,
            R.drawable.l2_rectangle
    };
