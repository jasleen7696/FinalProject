...
public class LevelTwoAnimalsCardAdapter extends PagerAdapter {

    Context context;
    LayoutInflater inflater;

    public LevelTwoAnimalsCardAdapter(Context context) {
        this.context = context;
    }

    public int[] slide_images = {
            R.drawable.l2_dog,
            R.drawable.l2_parrot,
            R.drawable.l2_bear,
            R.drawable.l2_giraffe,
            R.drawable.l2_tiger,
            R.drawable.l2_cat,
            R.drawable.l2_elphant,
            R.drawable.l2_horse,
            R.drawable.l2_lion,
            R.drawable.l2_owl
    };
